...
*** Variables ***
${sl_user_name}    panda.bot1.ext@foodpanda.com
${sl_password}     Automation_123456
${region_name}     FP PS HK Wastage Team
${GO_TO_URL_QUEUE}      https://deliveryhero.lightning.force.com/lightning/o/Case/list?filterName=FP_PS_HK_Wastage_Team
${contact_email}
${translated_text}
${PandaBotName}   Panda Bot1
@{contact_email}
@{itemss}=
@{itemss_qan}=
${TicketID}
...
${gmail_password_onv}    Pandabot!12345
${IMAP_HOST}         imap.gmail.com
${IMAP_PORT}         993
${APP_PASSWORD}      syhh ssra gesv ljro  # Use the app password generated earlier
${alert_failure_count}     3
${region}   Hongkong

*** Tasks ***
FP PS HK Wastage Bot 1 Main Task
    Log  Queue Name: ${region_name}
    FP PS HK Wastage Bot 1
*** Keywords ***
Start Chrome Browser
    ${options}=    Evaluate    sys.modules['selenium.webdriver'].ChromeOptions()    sys, selenium.webdriver
    Call Method    ${options}    add_argument   --remote-debugging-port\=9232
    Call Method    ${options}    add_argument   --user-data-dir\=\\Chrome_user_dir_16\\User Data 16\\Default
    Call Method    ${options}    add_argument   --profile-directory\=PandaBot16
