...
*** Variables ***
${sl_user_name}    panda.bot17.ext@foodpanda.com
${sl_password}     Automation_123456
${region_name}     FP PS HK Wastage Team  (Bot 2)
${GO_TO_URL_QUEUE}      https://deliveryhero.lightning.force.com/lightning/o/Case/list?filterName=FP_PS_HK_Wastage_Team_Bot_2
${contact_email}
${translated_text}
${PandaBotName}   Panda Bot17
@{contact_email}
@{itemss}=
@{itemss_qan}=
${TicketID}
...
${gmail_password_onv}  foodpandabot_17
${IMAP_HOST}         imap.gmail.com
${IMAP_PORT}         993
${APP_PASSWORD}      hnhe oyyr byzx wqao  # Use the app password generated earlier
${alert_failure_count}     3
${region}   Hongkong

*** Tasks ***
FP PS HK Wastage Bot 17 Main Task
...
Start Chrome Browser
    ...
    Call Method    ${options}    add_argument   --remote-debugging-port\=9233
    Call Method    ${options}    add_argument   --user-data-dir\=\\Chrome_user_dir_17\\User Data 17\\Default
    Call Method    ${options}    add_argument   --profile-directory\=PandaBot17
